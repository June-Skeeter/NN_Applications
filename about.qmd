...
We provide a tollset and examples demonstrating how NN models can be applied to EC data for both descriptive analysis and inferential modelling.
 
* The github repo associated with this presentation has Python code that can be used to apply NN models.
